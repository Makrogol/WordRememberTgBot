...
class TestBotShowCurrentIntervals(unittest.TestCase):
    def test_show_current_intervals_not_set_intervals(self):
        ...
        self.assertEqual(context.bot.get_messages(), [
            ShowCurrentIntervalsMessages.SUCCESS_SHOW_CURRENT_INTERVALS_TEXT + Intervals().get_as_string()])
    ...
    def test_show_current_intervals_set_intervals(self):
        ...
        self.assertIn(ShowCurrentIntervalsMessages.SUCCESS_SHOW_CURRENT_INTERVALS_TEXT + intervals.get_as_string(),
