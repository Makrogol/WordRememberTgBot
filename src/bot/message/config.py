...
TRY_ADD_NEW_WORD_WITH_COMMAND_TEXT = ("Попробуй добавить слово для повторения с помощью команды /anw "
                                      "или посмотри справку с помощью команды /help")

FILE_DOES_NOT_EXIST_TEXT = ("Невозможно получить все твои слова в виде файла. "
                            "Скорее всего ты еще не ввел ни одно слово. ") + TRY_ADD_NEW_WORD_WITH_COMMAND_TEXT

WORDS_ARE_EMPTY_TEXT = "Ты еще не ввел ни одно слово. " + TRY_ADD_NEW_WORD_WITH_COMMAND_TEXT
