...
from src.core.command.commands import ALL_COMMANDS_ATTRS, Commands
...
HELP_MESSAGES_BY_COMMANDS = {
    getattr(Commands, commands_attr): getattr(HelpMessages, get_help_message_attr_by_command_attr(commands_attr))
